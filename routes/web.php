...
Route::middleware([
    ...
    Route::get('/b-trip/{b-trip}/show', [BusinessTripController::class, 'show'])->name('b-trip.show');
    Route::get('/b-trip/{b-trip}/edit', [BusinessTripController::class, 'edit'])->name('b-trip.edit');
    Route::post('/b-trip/{b-trip}', [BusinessTripController::class, 'update'])->name('b-trip.update');
    Route::delete('/b-trip/{b-trip}/destroy', [BusinessTripController::class, 'destroy'])->name('b-trip.destroy');
