<x-app-layout>
            ...
            <div class="w-full h-full overflow-x-auto">
                <table class="w-full mt-4 text-left table-fixed min-w-max">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-4 border-b border-slate-200">{{$Salary->date}}</td>
                            <td class="p-4 border-b border-slate-200">{{$Salary->sum}}</td>
                            <td class="p-4 border-b border-slate-200">{{$Salary->comment}}</td>
                            <td class="p-4 border-b border-slate-200">
                                <div class="inline-flex items-center rounded-md shadow-sm">
                                    <a href="{{ route('salary.show', $Salary) }}"
                                    ...
                                    <a href="{{ route('salary.destroy', $Salary) }}"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                class="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border overflow-x-auto">
                <table class="w-full mt-4 text-left table-fixed min-w-max">
                    <thead>
                        <tr>
                            <th
