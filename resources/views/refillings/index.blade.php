            ...
            <div class="w-full h-full overflow-x-auto">
                <table class="w-full mt-4 text-left table-fixed min-w-max">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-4 border-b border-slate-200">{{$Refilling->refilling_date}}</td>
                            ...
                            <td class="p-4 border-b border-slate-200">
                                <div class="inline-flex items-center rounded-md shadow-sm">
                                    <a href="{{ route('refilling.show', $Refilling) }}"
                                    ...
                                    <a href="{{ route('refilling.edit', $Refilling) }}"
                                    ...
                                    <form action="{{ route('refilling.destroy', $Refilling) }}" method="POST"
