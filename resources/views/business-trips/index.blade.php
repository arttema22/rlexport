            ...
            <div class="w-full h-full overflow-x-auto">
                <table class="w-full mt-4 text-left table-fixed min-w-max">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-4 border-b border-slate-200">{{$BusinessTrip->b_trip_date}}</td>
                            <td class="p-4 border-b border-slate-200">{{$BusinessTrip->sum}}</td>
                            <td class="p-4 border-b border-slate-200">{{$BusinessTrip->comment}}</td>
                            <td class="p-4 border-b border-slate-200">
                                <div class="inline-flex items-center rounded-md shadow-sm">
                                    <a href="{{ route('b-trip.show', $BusinessTrip) }}"
                                    ...
                                    <a href="{{ route('b-trip.edit', $BusinessTrip) }}"
                                    ...
                                    <form action="{{ route('b-trip.destroy', $BusinessTrip) }}" method="POST"
