            ...
            <div
                ...
                <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                    <div class="flex items-center justify-between ">
                        <div>
                            <h3 class="text-lg font-semibold text-slate-800">{{ __('Business Trips') }}</h3>
                ...
                <div class="p-0 overflow-scroll">
                    <table class="w-full mt-4 text-left table-auto min-w-max">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="p-4 border-b border-slate-200">{{$Btrip->date}}</td>
                                <td class="p-4 border-b border-slate-200">{{$Btrip->sum}}</td>
                                <td class="p-4 border-b border-slate-200">{{$Btrip->comment}}</td>
