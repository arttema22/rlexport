<div class="max-w-6xl mx-auto my-4 p-4 overflow-hidden border sm:rounded-lg">
        ...
        <x-slot name="content">
            ...
            <x-blocks.accordion>
                ...
                <x-blocks.content-accordion>
                    <div class="mr-2 p-2 text-xs text-gray-600 leading-relaxed">
    ...
    <div class="flex flex-wrap gap-8 max-w-sm mx-auto">
        <svg xmlns="http://www.w3.org/2000/svg" class="spinner-8 w-10 h-10 shrink-0 animate-spin" viewBox="0 0 512 512">
            <path
